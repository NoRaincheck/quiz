...
Now that you understand call options, let's explore put options. The concepts are exactly the same,
but everything is flipped on its head. Put option prices increase as the stock price falls, and
decrease as the stock price rises.

---

## What is a Put Option?

A put option gives the buyer the **right to sell 100 shares** of stock at the strike price between
...
**Key insight:** While IWM shares fell only 6.1%, the put option gained 81% — demonstrating the
leverage of options.
...
**What happened:** After the initial sell-off, NVIDIA surged to $321 (over $40 above the strike
price). With only one day left until expiration, the put option was trading for pennies —
...
Just like call options, 99% of put option trades are closed by selling the option, not by exercising
it. The option's market price already reflects its exercise value.
...
_Study guide based on options trading fundamentals. Always do your own research before trading._
